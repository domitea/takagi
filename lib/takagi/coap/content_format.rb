...
module Takagi
  module CoAP
    ...
    #   Takagi::CoAP::ContentFormat.register(65000, 'application/custom', :custom)
    #   Takagi::CoAP::ContentFormat::CUSTOM  # => 65000
    #
    # @example Looking up format names
    #   Takagi::CoAP::ContentFormat.name_for(50)  # => "application/json"
    class ContentFormat < Registry
