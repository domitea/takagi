...
require_relative 'registries/base'

module Takagi
  module CoAP
    # Backward compatibility alias for Registries::Base
    #
    # @deprecated Use {Registries::Base} instead. This alias will be removed in v2.0.0
    #
    ...
    #   class MyRegistry < Takagi::CoAP::Registries::Base
